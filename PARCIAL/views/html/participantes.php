...
<head>
    ...
    <title>Gestión de Participantes - Sistema de Eventos Deportivos</title>
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="mb-3">
            <input type="text" id="busqueda" class="form-control" placeholder="Buscar participantes...">
        </div>

        <button class="btn btn-primary mb-3" id="btnNuevoParticipante">Nuevo Participante</button>
